...
def admin_reset_all_data():
    ...
    targets = ['Vehicles', 'ChargeLogs', 'TripLogs', 'MaintenanceTasks', 'TelemetryPoints']
...
def get_telemetry():
    """Trả telemetry — từ Firestore nếu có, fallback seed data."""
    if _fs():
...
def get_charge_logs():
    """Public charge logs — fallback in-memory seed."""
