...
MODEL_TYPES: Dict[str, Dict[str, Any]] = {
    ...
    "dte": {
        ...
        "icon": "Gauge",
        "accent": "blue",
        "description": "Dự đoán phần trăm SOC tiêu thụ dựa trên dữ liệu của chuyến đi.",
        "useCase": "Ước tính mức pin tiêu thụ từ quãng đường, tốc độ, gia tốc, tải trọng, nhiệt độ, thời tiết và địa hình.",
        "outputDescription": "Phần trăm pin dự kiến tiêu thụ trong chuyến đi.",
        "outputUnit": "%",
        "outputMeaning": "Độ giảm SOC dự kiến, tính theo điểm phần trăm.",
        "input_fields": [
